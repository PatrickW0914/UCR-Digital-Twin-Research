...
model Circuit_3B_S3 "Feeder 3B scenario S3: distributed rooftop PV + HSS_3B BESS"
  ...
  // Sizing matches the 3A pattern: PV nameplate equal to or a bit below the host transformer kVA, all behind-the-meter(non-export). BESS at the largest LV load center.
